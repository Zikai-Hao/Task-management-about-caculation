                        ...
                        '<div class="zm-editable-editor-wrap no-toolbar">',
                            '<div class="zm-editable-editor-outer">',
                                '<div class="zm-editable-editor-field-wrap">',
                                    '<textarea class="js-content zm-editable-editor-field-element editable" placeholder="问题背景、条件等详细信息，不得多于120字" style="font-style:italic;width:98%;"></textarea>',
                                '</div>',
                            '</div>',
                        '</div>',
                    '</div>',
        ...
        var oPopup = new Popup({
            ...
            ok: function () {
                ...
                $.ajax({
                    ...
                    // 未登陆，跳转到登陆页面
                    if (oResult.code === 999) {
                        window.location.href = '/reglogin?type=login&next=' + window.encodeURIComponent(window.location.href);
                    } else {
